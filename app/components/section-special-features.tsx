...
const SpecialFeatures = () => {
    return (
      ...
      aspect-768/650 bg-[url('/images/bg-mb-special-features.jpg')] md:aspect-192/95 md:bg-[url('/images/bg-special-features.jpg')]">
        ...
        <div className="relative w-full md:w-[68%] aspect-1090/693 flex justify-center items-center">
            ...
            >
              {features.map((feature, idx) => (
                <SwiperSlide key={idx} className='swiper-slide' style={{width: '80%'}}>
                  <div className="w-full p-[2%] overflow-hidden aspect-1090/693 flex items-center justify-center bg-contain bg-center bg-no-repeat bg-[url('/images/frame-banner.png')]">
                    <img
                      src={feature.image}
                      alt={feature.alt}
